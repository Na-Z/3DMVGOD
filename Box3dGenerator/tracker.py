...
def exhaustive_association(scan_dir, trajectories, frame_names, objects, poses, K, MIN_DIST=125, MAX_ANGLE=110,
                           MIN_SIZE_RATIO=0.5, MIN_TRACK_LENGTH=3, to_visualize_epipolar=False,
                           to_visualize_traj=False, to_visualize_rotation=False):
    '''
    ...
    :param MAX_ANGLE: the maximum angle threshold to determine if pair two frames
...
def tracking(scan_dir, scan_name, valid_frame_names, min_ratio=9, pairwise_min_scale=0.4, pairwise_min_dist=50,
             ...
             exhaustive_max_angle=110, exhausive_min_size_ratio=0.5, min_track_length=3,
    ...
    full_trajectories = exhaustive_association(scan_dir, trajectories, frame_names, objects, poses, K,
                                               exhaustive_min_dist, exhaustive_max_angle, exhausive_min_size_ratio,
                                               min_track_length, visu_exhaustive_epipolar, visu_exhaustive_traj,
                                               visu_exhaustive_rotation)
