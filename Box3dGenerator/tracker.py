...
def exhaustive_association(scan_dir, trajectories, frame_names, objects, poses, K, MIN_DIST=125, MAX_ANGLE=110,
                           to_visualize_epipolar=False, to_visualize_traj=False, to_visualize_rotation=False):
    ...
    def _calc_forward_backward_DIST(src_obj_index, dst_obj_index):
        ...
        if to_visualize_epipolar and 150<dist < MIN_DIST:
    ...
    #TODO: filter out the bbox that lower than certain ratio of the average size of its trajectory
